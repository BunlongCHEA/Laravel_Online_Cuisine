...
<div class="container mt-4">
    ...
    <div class="d-flex justify-content-end mb-3">        
        <div style="margin: 10px;">
            <!-- Create Cuisine Button -->
            <a href="{{ route('admins.cuisines.create') }}" class="btn btn-success">Add New Cuisine</a>
        </div>

        <div style="margin: 10px;">
            <!-- View Category Button -->
            <a href="{{ route('admins.categories.index') }}" class="btn btn-success">Go To Category</a>
        </div>
        ...
        <div style="margin: 10px;">
            ...
            <!-- this.form.submit() : automatically submit the form when changing the value of the dropdown (<select>) -->
            <form action="{{ route('admins.cuisines.index') }}" method="GET" class="form-inline">
            ...
            <div class="col-md-4 mb-4">
                <div class="card h-100">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">
                            ...
                            @if (Str::length($cuisine->description) > 150)
                                <a href="{{ route('admins.cuisines.show', $cuisine->id) }}" class="text-primary">Read more</a>
                            @endif
                        </p>
                    ...
                    <div class="card-footer">
                        <a href="{{ route('admins.cuisines.show', $cuisine->id) }}" class="btn btn-info btn-sm">Show</a>
                        <a href="{{ route('admins.cuisines.edit', $cuisine->id) }}" class="btn btn-primary btn-sm">Edit</a>
                        <form action="{{ route('admins.cuisines.destroy', $cuisine->id) }}" method="POST" style="display:inline;">
                            @csrf
                            @method('DELETE')
                            <button type="submit" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this cuisine?')">Delete</button>
                        </form>
                    </div>
                </div>
            </div>
